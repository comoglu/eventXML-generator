...
class MapWidget(QWidget):
    ...
    def update_map(self, coordinate):
        ...
        self.webView.page().runJavaScript('''
            ...
            // Run initMap after a short delay to ensure the page has loaded
...
class SeismicEventGeneratorGUI(QMainWindow):
    ...
    def init_ui(self):
        ...
        focal_layout.addWidget(self.beachball, 0, 2, 6, 1)
    ...
    def save_config(self):
        ...
        self.config['Magnitudes'] = {
            mag_type: edit.text() for mag_type, edit in self.magnitude_edits.items()
        }
